...
export function DataTablePagination<TData>({
  ...
  return (
    <div className="flex w-full flex-col-reverse items-center justify-between gap-4 overflow-auto p-1 lg:flex-row lg:gap-8">
      ...
      <div className="flex flex-col-reverse items-center gap-4 lg:flex-row md:gap-6 lg:gap-8">
        <div className="flex items-center space-x-2">
          <p className="whitespace-nowrap text-sm font-medium">Itens por página</p>
          <Select
          ...
          >
            <SelectTrigger className="h-8 w-18">
              <SelectValue placeholder={table.getState().pagination.pageSize}>
                {(value: string) =>
                  pageSizeOptions.find((pageSize) => `${pageSize}` === value) ??
